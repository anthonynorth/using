...
##'
##' This function is intended to always be called with the `using::` prefix. A
##' call without this prefix will throw a warning. This simplifies detecting
##' dependencies declared by using::pkg for use with `{renv}` and `{capsule}`
#'
#' @title using::pkg
...
#'
#' @export
pkg <- function(package, min_version = NULL, repo = NULL, ...) {
